...
appRoutes.post('/habits', async (request: Request, response: Response) => {
...
appRoutes.get('/day', async (request: Request, response: Response) => {
...
appRoutes.patch('/habits/:id/toggle', async (request: Request, response: Response) => {
...
appRoutes.get('/summary', async (request: Request, response: Response) => {
